class TabManager {
    ...
    initializeEventListeners() {
        ...
        document.getElementById("iy").addEventListener("click", () => {
            parent.execute("loadstring(game:HttpGet('https://lua.peretas.tech/iballexus/infiniteyield.lua'))()");
        });
        ...
        document.getElementById("save").addEventListener("click", () => {
            ...
            try {
                ...
                link.href = url;
                link.download = `${activeTab.title}.lua`;
                ...
                parent.showNotification("Success", "File downloaded successfully!", 2000);
                setTimeout(() => {
                    parent.showNotification("Didn't work?", "The Save File function has some bugs I don't know how to fix. Will fix next update.", 5000);
                }, 2000);
            } catch (error) {
                console.error("Save failed:", error);
                parent.showNotification("Error", "Failed to save file!", 2000);
            }
        });
